...
"""
entire_tsne_pre_pca.py

Script that first runs principal component analysis to reduce the VCF dataset
to a 50-dimensional space, then second runs t-distributed stochastic neighbor embedding 
to project olfactory data to 2 dimensions.

Usage:
    python3 entire_tsne_pre_pca.py
...
def main(config_path: str) -> None: 
    try:
        ...
        perplexity = 30
        X_tsne = TSNE(tsne_components, perplexity=perplexity, random_state=1).fit_transform(X_pca)
