...
class SampleWordDataset():
    """This dataset class can load in a text embedding dataset of sample words with a specified path and threshold.
    ...
    def get_dataframe(self):
        """Returns a Pandas Dataframe of the Sample Word Text Embedding dataset given the specified threshold."""
    ...
    def get_indices(self):
        """Returns a list of indices of the Sample Word text embed dataset given the specified threshold."""
